            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="/spring/resources/img/blog/single_blog_1.png" alt="">
                  </div>
                  <div class="blog_details">
                     <h2>이벤트제목 
                     </h2>
                     <ul class="blog-info-link mt-3 mb-4">
                        <li><a><i class="far fa-user"></i> 날짜... </a></li>
                     </ul>
                  ...
                  <div class="navigation-area">
                     <div class="row">
                        <div
                           ...
                           <div class="thumb">
                              <a href="/single-event.action">
                                 <img class="img-fluid" src="/spring/resources/img/post/preview.png" alt="">
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="/single-event.action">
                        ...
                        <div
                           ...
                           <div class="thumb">
                              <a href="/single-event.action">
                                 <img class="img-fluid" src="/spring/resources/img/post/next.png" alt="">
                              </a>
                           </div>
                        </div>
                     </div>
