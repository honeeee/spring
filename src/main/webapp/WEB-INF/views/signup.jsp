			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						<a class="navbar-brand" href="/spring"> <img
							src="/spring/resources/img/logo.png" alt="logo">
						</a>
						...
						<div class="collapse navbar-collapse main-menu-item"
							...
							<ul class="navbar-nav">
								<li class="nav-item"><a class="nav-link" href="/spring">Home</a>
								</li>
								...
								<li class="nav-item dropdown"><a
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
										<a class="dropdown-item" href="category.action"> 침실 </a>
										<!-- 여기서 침실값을 가져가서 각 리스트로 이동  -->
										<a class="dropdown-item" href="category.action"> 거실 </a> <a
											class="dropdown-item" href="category.action"> 서재 </a>
									</div></li>

								<li class="nav-item"><a class="nav-link"
									href="event.action">Event</a></li>

								<li class="nav-item"><a class="nav-link"
									href="contact.action">Contact</a></li>

								<li class="nav-item"><a class="nav-link"
									href="mypage.action">My Page</a></li>
							</ul>
						</div>
						<div class="hearer_icon d-flex">
							<a href="login.action">로그인</a> &nbsp;/&nbsp; <a
								href="signup.action">회원가입</a> <a id="search_1"
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-8">
						...
						<form action="#">
							...
							<div class="mt-10">
									<div class="default-select" id="phone1">
										<select>
								...
								<input type="text" name="phone2" placeholder="휴대전화"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = '휴대전화'" required
									class="single-input">
							</div>
			...
			<div class="row justify-content-around">
				<div class="col-sm-6 col-lg-8">
					<div class="single_footer_part">
						...
						<a> 우리나라 주거 환경 변화를 주도해 침실, 거실, 욕실 등 주택의 각 공간에 가구와 기기, 소품, 패브릭
							등을 제공하는 홈 인테리어 기업입니다 </a> </br> <a> 상 호 명 : (주)원더 </a>&nbsp;|&nbsp; <a>
							대표이사 : 김홍희 </a>&nbsp;|&nbsp; <a> 주 소 : 서울특별시 중구 명동 세종대로 110 </a>&nbsp;|&nbsp;
					...
					<div class="col-lg-4">
						<div class="footer_icon social_icon">
							<ul class="list-unstyled">
								<li><a class="single_social_icon"><i
